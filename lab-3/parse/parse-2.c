...
const char *argp_program_version = "parse 2.0";
...
static char args_doc[] = "INT1 INT2 INT3";
...
int main(int argc, char **argv) {
	...
	printf("Arguments\n"
		"Number One: %d\tNumber Two: %d\tNumber Three: %d\n"
		"Verbose: %d\tFile: %s\n",
		arguments.arg_num[0],arguments.arg_num[1],arguments.arg_num[2],
